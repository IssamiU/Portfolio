    ...
    <PageTransition>
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16 sm:py-24">
        <div className="text-center mb-16">
          <p className="text-sm font-mono text-primary uppercase tracking-widest mb-3">Conquistas</p>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold gradient-text">Certificados</h1>
        ...
        {certificates.length === 0 && (
          <div className="text-center py-20">
            <p className="text-muted-foreground">Em breve novos certificados serão adicionados.</p>
          </div>
        )}
      </div>
    </PageTransition>
