...
function ExperienciaPage() {
  ...
  const summaryCards = [
    ...
    {
      title: "Atual",
      value: currentExperience?.type ?? "Em evolução",
      icon: Cpu,
    },
  ];
                      ...
                      <div className="relative overflow-visible rounded-[2rem] border border-white/10 bg-card/80 p-6 sm:p-8">
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            ...
                            {exp.duration && (
                              <span className="w-fit min-w-[190px] max-w-full shrink-0 rounded-full border border-primary/30 bg-primary/10 px-5 py-2 text-center text-xs font-mono leading-relaxed text-primary whitespace-nowrap">
                                {exp.duration}
                              </span>
                            )}
                          </div>
