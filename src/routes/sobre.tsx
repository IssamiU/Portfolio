    ...
    <PageTransition>
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="mb-16 text-center">
          ...
          <h1 className="font-display text-4xl font-bold gradient-text sm:text-5xl lg:text-6xl">
            Sobre Mim
          </h1>
        </div>
        ...
        <FadeInView>
          <div className="grid items-start gap-8 lg:grid-cols-[1fr_1.5fr]">
            <div className="flex flex-col">
              ...
              >
                <div className="mx-auto mb-4 h-28 w-28 rounded-full bg-gradient-to-br from-primary to-accent p-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-primary/20 bg-primary/10 px-4 py-2.5 text-sm font-medium text-primary transition-colors hover:bg-primary/20"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <div className="mt-10 flex justify-center">
                <motion.img
                  ...
                  className="h-[380px] w-auto object-contain select-none pointer-events-none drop-shadow-[0_12px_30px_rgba(0,212,255,0.10)]"
                  animate={{
                    y: [0, -8, 0],
                    rotate: [0, 1, -1, 0],
                    scale: [1, 1.015, 1],
            ...
            <div className="space-y-6">
              <div className="glass rounded-2xl p-8">
                <h2 className="mb-4 font-display text-xl font-bold gradient-text">
                  Quem eu sou
                </h2>
              ...
              <div className="glass rounded-2xl border-l-4 border-primary/50 p-8">
                <h2 className="mb-4 font-display text-xl font-bold gradient-text">
                  Objetivo
                </h2>
        ...
        <FadeInView delay={0.15}>
          <div className="mt-16">
            <h2 className="mb-8 font-display text-2xl font-bold gradient-text">
              Trajetória
            </h2>

            <div className="relative space-y-0">
              <div className="absolute bottom-0 left-4 top-0 w-px bg-gradient-to-b from-primary/50 via-accent/30 to-transparent" />
              ...
              {timeline.map((item, i) => (
                ...
                >
                  <div className="ring-background absolute left-2.5 top-1 h-3 w-3 rounded-full bg-primary ring-4" />
                  ...
                  <div className="glass rounded-xl p-6">
                    <div className="mb-2 flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
                      ...
                      <span className="w-fit rounded-full bg-primary/10 px-2 py-1 font-mono text-xs text-primary">
                        {item.status}
                      </span>
                    </div>
        ...
        <FadeInView delay={0.2}>
          <div className="mt-16">
            <h2 className="mb-8 text-center font-display text-2xl font-bold gradient-text">
